	...
	class BEWPI_Settings_Invoices extends BEWPI_Settings_Page {
		...
		public function get_sections() {
			...
			$sections = array(
				...
				'template'    => __( 'Template', 'woocommerce-pdf-invoices' ),
		...
		public function get_settings( $current_section = '' ) {
			...
			if ( 'debug' === $current_section ) {
				...
				$settings = apply_filters( 'woocommerce_invoices_template_settings', array(

					array(
						'title' => __( 'Template Options', 'woocommerce-pdf-invoices' ),
						'desc'  => 'These are the universal template options that are used for every type of PDF.',
						'type'  => 'title',
					...
					array(
						...
						'id'       => 'bewpi_company_name',
						'css'      => 'min-width:300px;',
						'default'  => esc_html( get_bloginfo() ),
						'type'     => 'text',
					),
					...
					array(
						...
						'id'       => 'bewpi_company_address',
						'css'      => 'min-width:300px;min-height:140px;',
						'default'  => '',
						'type'     => 'textarea',
						'desc_tip' => __( 'Choose which company address and additional details to show.', 'woocommerce-pdf-invoices' ),
					),
